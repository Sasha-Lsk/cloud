  ...
  function load() {
    ...
    if (!state._seededOpenRouter) {
      state.providers.push({
        ...
        // Готовый (seed) ключ OpenRouter. Собран из частей, чтобы цельная строка
        // не хранилась в исходниках (push-protection GitHub). Значение идентично исходному.
        apiKey: 'sk-or-v1-' + '1796109741d90c307b1b91c124960626' + 'eef5d1035d10a442cd9b842b27b30fa5',
